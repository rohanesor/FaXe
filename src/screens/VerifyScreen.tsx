...
import { recognizeFace } from '../modules/recognition';
  ...
  const handleFaceAligned = async (frameData: AlignedFaceFrame) => {
    ...
    try {
      ...
      if (livenessResult.passed) {
        ...
        // Run Main offline face recognition matching scan with an empty candidates array for now
        const recognitionResult = await recognizeFace(frameData, []);
